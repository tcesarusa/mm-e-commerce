                    ...
                    <div class="tab-pane  active" id="blockView">
                        <ul class="thumbnails">
                            <?php foreach ($products_category as $products) {
                                    ...
                                    <li class="span3">
                                        <div class="thumbnail">
                                            <a  href="<?php echo site_url(); ?>Customer_products/product_details/<?php echo $products->product_meta; ?>"><img src="<?php echo $products->product_image_thumb; ?>" title="<?php echo $products->product_name; ?>" alt="<?php echo $products->product_name; ?>" style="height:260px;"/></a>
